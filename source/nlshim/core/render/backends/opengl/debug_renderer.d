...
import nlshim.core.render.backends.opengl.soa_upload : glUploadFloatVecArray;
...
package(nlshim) void oglInitDebugRenderer() {
    ensureInitialized();
}

package(nlshim) void oglSetDebugPointSize(float size) {
    glPointSize(size);
}

package(nlshim) void oglSetDebugLineWidth(float size) {
    glLineWidth(size);
}

package(nlshim) void oglUploadDebugBuffer(Vec3Array points, ushort[] indices) {
    ensureInitialized();
...
package(nlshim) void oglSetDebugExternalBuffer(RenderResourceHandle vertexBuffer, RenderResourceHandle indexBuffer, int count) {
    ensureInitialized();
...
package(nlshim) void oglDrawDebugPoints(vec4 color, mat4 mvp) {
    ensureInitialized();
...
package(nlshim) void oglDrawDebugLines(vec4 color, mat4 mvp) {
    ensureInitialized();
    if (indexCount <= 0) return;
...
package(nlshim) void oglInitDebugRenderer() {}
package(nlshim) void oglSetDebugPointSize(float) {}
package(nlshim) void oglSetDebugLineWidth(float) {}
package(nlshim) void oglUploadDebugBuffer(Vec3Array, ushort[]) {}
package(nlshim) void oglSetDebugExternalBuffer(RenderResourceHandle, RenderResourceHandle, int) {}
package(nlshim) void oglDrawDebugPoints(vec4, mat4) {}
package(nlshim) void oglDrawDebugLines(vec4, mat4) {}
